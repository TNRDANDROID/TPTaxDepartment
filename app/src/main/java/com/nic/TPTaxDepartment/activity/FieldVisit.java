...
//        Toast.makeText(getContext(), countryNames[position], Toast.LENGTH_LONG).show();
    ...
    public JSONObject fieldJsonParams() throws JSONException {
        ...
        JSONObject data = new JSONObject();
            data.put(AppConstant.KEY_SERVICE_ID, "TradersFieldVisitHistoryService");
        ...
        try {
            ...
            if (jsonarray != null && jsonarray.length() > 0) {
                for (int i = 0; i < jsonarray.length(); i++) {
                    ...
                    String Request_id = Utils.NotNullString(jsonobject.getString("tradersdetails_id"));
                    String TraderName = Utils.NotNullString(jsonobject.getString("tradersdetails_id"));
                    String FieldVisitDate = Utils.NotNullString(jsonobject.getString("tradersdetails_id"));
                    String TaxTypeName = Utils.NotNullString(jsonobject.getString("tradersdetails_id"));
                    String Status = Utils.NotNullString(jsonobject.getString("tradersdetails_id"));
                    String Wardname = Utils.NotNullString(jsonobject.getString("tradersdetails_id"));
                    String Streetname = Utils.NotNullString(jsonobject.getString("tradersdetails_id"));
                    String Remark = Utils.NotNullString(jsonobject.getString("tradersdetails_id"));
