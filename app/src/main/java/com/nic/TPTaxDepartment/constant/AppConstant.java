package com.nic.TPTaxDepartment.constant;
...
public class AppConstant {
    ...
    public static String LB_TYPE = "lbtype";
    ...
    public static String DISTRICT_NAME_EN = "district_name_en";
    public static String LBODY_NAME_EN = "lbody_name_en";
    public static String USER_FNAME = "user_first_name";
    public static String USER_LNAME = "user_last_name";
    ...
    public static String INSTALLMENT_TYPE_ID = "installmenttypeid";
